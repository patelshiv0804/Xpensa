...
export default function Navbar_logout({ setIsLoggedIn, onMenuToggle, isProfileVisible }) {
        ...
        <>
            <div className={styles.navbar}>
                <div className={styles.left_section}>
                    <Logo />
                    {/* Menu button for profile toggle */}
                    <button
                        className={styles.menu_button}
                        onClick={handleMenuToggle}
                        title={isProfileVisible ? "Hide Menu" : "Show Menu"}
                    >
                        <div className={`${styles.menu_icon} ${isProfileVisible ? styles.menu_icon_active : ''}`}>
                            <span></span>
                            <span></span>
                            <span></span>
                        </div>
