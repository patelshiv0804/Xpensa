...
//         // Reset comparison data when period type changes
//         setComparisonData([]);
...
//         // Reset comparison data when month changes
//         setComparisonData([]);
//         setSelectedCategories([]);
//     };
...
//     // Add selected category to comparison
//     const addCategoryToComparison = async () => {
//         if (!selectedCategory) return;

//         // Check if the category is already added
//         if (selectedCategories.some(cat => cat.cid === selectedCategory)) {
//             setError('This category is already added to comparison');
//             return;
//         }
...
//                 // Clear the selected category dropdown for next selection
//                 // Leave it populated but don't reset it
//                 // setSelectedCategory('');
//             } else {
//                 setError(`No expense data found for this ${periodType} in the selected category`);
//             }
//         } catch (error) {
...
//     // Remove category from comparison
//     const removeCategory = (categoryId) => {
//         setSelectedCategories(selectedCategories.filter(cat => cat.cid !== categoryId));
//         setComparisonData(comparisonData.filter(item => item.category.cid !== categoryId));
//     };
...
//                 {/* Month selection - only show if periodType is 'month' */}
//                 {periodType === 'month' && (
//                     <Grid item xs={12} md={3}>
//                         <FormControl fullWidth size="medium">
...
//                 {/* Category selection */}
//                 <Grid item xs={12} md={periodType === 'month' ? 3 : 6}>
//                     <FormControl fullWidth size="medium">
...
//                         color="primary"
//                         fullWidth
//                         onClick={addCategoryToComparison}
//                         disabled={!selectedCategory || loading}
//                         className="add-button"
//                         sx={{ height: '56px' }} // Match height with Select component
//                     >
//                         {loading ? <CircularProgress size={24} color="inherit" /> : 'Add to Comparison'}
//                     </Button>
//                 </Grid>
//             </Grid>
...
//                                             size="small"
//                                             color="error"
//                                             onClick={() => removeCategory(category.cid)}
//                                         >
//                                             <DeleteIcon />
//                                         </IconButton>
//                                     </CardContent>
...
//                                     <TableRow key={item.category.cid}>
...
//                         Select categories to compare expense
//                     </Typography>
//                 )
//             )}
//         </Container>
